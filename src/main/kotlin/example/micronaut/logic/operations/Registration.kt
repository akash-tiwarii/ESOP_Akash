...
fun registerUser(reg:Register): Any
{
    ...
    val ob= AccountInfo(reg.firstName,reg.lastName,reg.phoneNumber,reg.username,reg.email, Wallet(BigInteger("0"),BigInteger("0")),newInventory)
